<?php
/**
 * AppCustomizeGetFileContentFormFile
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AppCustomizeGetFileContentFormFile Class Doc Comment
 *
 * @category Class
 ...
 */
class AppCustomizeGetFileContentFormFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppCustomizeGetFileContentForm_file';
    ...
    */
     ...
     * Sets content_type
     *
     * @param string|null $content_type The MIME type of the uploaded file.
     *
     * @return self
     */
     ...
     * Sets file_key
     *
     * @param string $file_key The fileKey of the uploaded file.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The file name of the uploaded file.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param string|null $size The byte size of the uploaded file.
     *
     * @return self
     */
