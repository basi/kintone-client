...
/**
 * PreviewAppReportsGetSort Class Doc Comment
 *
 * @category Class
 * @package  Kintone
 * @author   OpenAPI Generator team
 ...
 */
class PreviewAppReportsGetSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreviewAppReportsGetSort';
    ...
    */
     ...
     * Sets by
     *
     * @param string|null $by How the graph is sorted. - TOTAL: Total - GROUP1: Level 1 - GROUP2: Level 2 - GROUP3: Level 3
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param string|null $order The order of sorting. - ASC: Ascending order - DESC: Descending order
     *
     * @return self
     */
