...
/**
 * PreviewRecordAclGetRight Class Doc Comment
 *
 * @category Class
 * @package  Kintone
 * @author   OpenAPI Generator team
 ...
 */
class PreviewRecordAclGetRight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreviewRecordAclGetRight';
    ...
    protected static $openAPITypes = [
        'entities' => '\Kintone\Model\PreviewRecordAclGetEntityRight[]',
        'filter_cond' => 'string'
    ];
    ...
    */
     ...
     * Gets entities
     *
     * @return \Kintone\Model\PreviewRecordAclGetEntityRight[]|null
     */
     ...
     * Sets entities
     *
     * @param \Kintone\Model\PreviewRecordAclGetEntityRight[]|null $entities An array listing the entities the permissions are granted to, in order of priority.
     *
     * @return self
     */
     ...
     * Sets filter_cond
     *
     * @param string|null $filter_cond The filter condition of the record permission.
     *
     * @return self
     */
