...
/**
 * BulkRequestPostUpsertRecordBean Class Doc Comment
 *
 * @category Class
 * @package  Kintone
 * @author   OpenAPI Generator team
 ...
 */
class BulkRequestPostUpsertRecordBean implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkRequestPostUpsertRecordBean';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The Record IDs of the updated/created Records.
     *
     * @return self
     */
     ...
     * Sets operation
     *
     * @param string|null $operation The revision numbers of the Records.
     *
     * @return self
     */
     ...
     * Sets revision
     *
     * @param int|null $revision The revision numbers of the Records.
     *
     * @return self
     */
