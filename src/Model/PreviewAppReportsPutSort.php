...
/**
 * PreviewAppReportsPutSort Class Doc Comment
 *
 * @category Class
 * @package  Kintone
 * @author   OpenAPI Generator team
 ...
 */
class PreviewAppReportsPutSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreviewAppReportsPutSort';
    ...
    public const BY_TOTAL = 'TOTAL';
    public const BY_GROUP1 = 'GROUP1';
    public const BY_GROUP2 = 'GROUP2';
    public const BY_GROUP3 = 'GROUP3';
    ...
    */
     ...
     * Sets by
     *
     * @param string $by How the graph is sorted. - TOTAL: Total - GROUP1: Level 1 - GROUP2: Level 2 - GROUP3: Level 3  Required when specifying the reports.{graphname}.sorts parameter.
     *
     * @return self
     */
    public function setBy($by)
    {
        ...
        $allowedValues = $this->getByAllowableValues();
        if (!in_array($by, $allowedValues, true)) {
     ...
     * Sets order
     *
     * @param string $order The order of sorting. - ASC: Ascending order - DESC: Descending order  Required when specifying the reports.{graphname}.sorts parameter.
     *
     * @return self
     */
