...
/**
 * SpaceThreadCommentPostFileForm Class Doc Comment
 *
 * @category Class
 * @package  Kintone
 * @author   OpenAPI Generator team
 ...
 */
class SpaceThreadCommentPostFileForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpaceThreadCommentPostFileForm';
    ...
    */
     ...
     * Sets file_key
     *
     * @param string $file_key The fileKey of the attachment file. fileKeys can be found from the response of the Upload File API.
     *
     * @return self
     */
