...
/**
 * RecordAclGetRight Class Doc Comment
 *
 * @category Class
 * @package  Kintone
 * @author   OpenAPI Generator team
 ...
 */
class RecordAclGetRight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecordAclGetRight';
    ...
    protected static $openAPITypes = [
        'entities' => '\Kintone\Model\RecordAclGetEntityRight[]',
        'filter_cond' => 'string'
    ];
    ...
    */
     ...
     * Gets entities
     *
     * @return \Kintone\Model\RecordAclGetEntityRight[]|null
     */
     ...
     * Sets entities
     *
     * @param \Kintone\Model\RecordAclGetEntityRight[]|null $entities An array listing the entities the permissions are granted to, in order of priority.
     *
     * @return self
     */
