<?php
/**
 * PostAppMoveForGuestSpaceRequest
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PostAppMoveForGuestSpaceRequest Class Doc Comment
 *
 * @category Class
 * @package  Kintone
 * @author   OpenAPI Generator team
 ...
 */
class PostAppMoveForGuestSpaceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postAppMoveForGuestSpaceRequest';
    ...
    */
     ...
     * Sets space
     *
     * @param int|null $space The Space ID of where the App will be moved to. To remove an App from its current space, null can be specified.
     *
     * @return self
     */
